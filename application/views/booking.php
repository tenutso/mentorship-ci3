    ...
    <div class="container">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6 pl-md-5">
                <p class="fs-18 mb-3 font-weight-bold"><?php echo trans('availability') ?></p>
                <form action="<?php echo base_url('booking/'.$session->slug.'/'. $session->uid.'?type=login') ?>" method="post">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="<?php if(check_auth() == false){echo 'hide';}else{echo 'show';} ?> booking_calendar" id="datepickers"></div>
