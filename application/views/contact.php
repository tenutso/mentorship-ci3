        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form method="post" action="<?php echo base_url('home/send_message'); ?>">
                    <div class="row">
                        <div class="col-sm-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name?url=http://www.tech.de/news/google-will-kein-eigenes-auto-mehr-bauen-10092492.html" placeholder="">
                            </div>
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary mt-3"><?php echo trans('submit') ?> </button>
                </form>
            </div>
        </div>
    </div>
