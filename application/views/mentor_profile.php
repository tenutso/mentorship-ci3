            ...
            <div class="col-md-8">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="media-body pt-3">
                        ...
                        <p class="text-muted mb-1"><i class="bi bi-arrow-repeat mr-2"></i> <?php echo trans('usually-responds-in') ?> <span class="text-dark fw-500"><?php echo html_escape($mentor->respond_time) ?> <?php echo html_escape($text); ?></span></p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php if (!empty($mentor->about_me)): ?>
                                <p class="pl-2 mb-5"><?php echo html_escape($mentor->about_me) ?></p>
                            <?php endif ?>
                                        ...
                                        <div class="sidebar-item mb-3 shadow-lg">
                                            <div class="sidebar-item-row d-flex justify-content-start align-items-center">
                                                ...
                                                <div class="sidebar-item-info">
                                                    ...
                                                    <p class="mb-0 sidebar-item-info text-muted fs-12"><?php echo html_escape($education->degree) ?> &bull; <?php echo show_year($education->start_year) ?> &bull; <?php echo show_year($education->end_year) ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach ?>
                            ...
                            <div class="right-overview shadow-lg br-10 ml-md-5">
                                ...
                                <form class="form-controls" action="<?php echo base_url('session') ?>" method="post">
                                    ...
                                    <div class="row pl-4 pr-3 mt-4">
                                        <?php $i=1; foreach ($sessions as $session): ?>
                                            <div class="col-md-12 col-xs-12">
                                                <label class="service-rdo">
                                                    <input data-id="<?php echo html_escape($session->slug) ?>" type="radio" name="session_id" class="service_input" value="<?php echo html_escape($session->id) ?>" required>
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            <div class="pt-3 pb-5">
                                                <a href="#" class="btn btn-primary btn-block btn-lg fs-14 sess_booking_btn disabled" ><?php echo trans('book-now') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
