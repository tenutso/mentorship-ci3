                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p class="text-muteds"><?php echo trans('we-are-thrilled-to-inform-you-that-your-account-with') ?> <?php echo settings()->site_name ?> <?php echo trans('successfully-approved-our-community') ?></p> <br>

                        <p>
                          <?php echo trans('best-regards') ?><br>
