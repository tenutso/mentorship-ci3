                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-xs-2">
                            <div class="form-group">
                                <select name="category" class="form-control sort_front custom-select">
                                    <option value=""> <?php echo trans('categories') ?></option>
                                    <?php foreach ($categories as $category): ?>
                                        <option <?php if(isset($_GET['category']) && $_GET['category'] == $category->slug){echo "selected";} ?> value="<?php echo html_escape($category->slug)?>"> <?php echo html_escape($category->name)?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mb-xs-2">
                            <div class="form-group">
                                <select name="mentor_search_skill" class="form-control sort_front custom-select">
                                    <option value=""><?php echo trans('skills') ?></option>
                                    <?php foreach ($skills as $skill): ?>
                                        <option <?php if(isset($_POST['mentor_search_skill']) && $_POST['mentor_search_skill'] == $skill->id){echo "selected";} ?> value="<?php echo html_escape($skill->id) ?>"><?php echo html_escape($skill->skill) ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
