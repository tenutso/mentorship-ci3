              ...
              <form method="post" action="<?php echo base_url('admin/payment/update') ?>" role="form" class="form-horizontal pr-20">
                <div class="row mb-4">
                  ...
                  <?php if (settings()->type == 'demo'): ?>
                      <div class="col-md-6">
                        <div class="card-body">
                        <div class="card p-2 mt-2 mr-2 bg-danger-soft">
                          <span><i class="fas fa-info-circle"></i><?php echo trans('payment-gateways-are-only-available-with-extended-license') ?></span>
                        </div>
                      </div>
                    </div>
                  <?php endif ?>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-6 mb-4">
                      <div class="card-body">
                          ...
                          <div class="form-group">
                              ...
                              <textarea id="summernote" class="richText" name="offline_details" placeholder="Provide your offline payment instructions here"><?php echo settings()->offline_details; ?></textarea>
                  ...
                  <div class="col-md-6">
                    <div class="card-footers mt-1">
                        <!-- csrf token -->
                        <input type="hidden" name="<?php echo html_escape($this->security->get_csrf_token_name());?>" value="<?php echo html_escape($this->security->get_csrf_hash());?>">
                        <button type="submit" class="btn btn-primary btn-lgs btn-block"> <?php echo trans('save-changes') ?></button>
                      </div>
                  </div>
                </div>
