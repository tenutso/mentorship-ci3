    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12 d-block">
          <div class="card">
              <div class="card-header"><h3 class="card-title"><?php echo trans('language-values') ?></h3></div>
              <div class="card-body">
                        ...
                        <div class="col-md-4 hides">
                          <div class="form-group">
                              ...
                              <select class="form-control" name="type" required>
                                  ...
                                  <option value="front"><?php echo trans('frontend') ?></option>
                                  <option value="admin"><?php echo trans('admin') ?></option>
                                  <option selected value="user"><?php echo trans('user') ?></option>
                              </select>
                          </div>
                        </div>
