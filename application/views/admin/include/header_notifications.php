...
<div class="dropdown-menu noti-card-position show_noti p-0 m-0">
  <?php foreach ($notifications as $notification): ?>
    ...
    <a href="<?php echo html_escape($noty_link) ?>" class="dropdown-item <?php if ($notification->seen == 0) {
         echo 'bg-light';
       } ?>">
      <div class=" py-2 d-flex justify-content-start">
        ...
        <div class="ml-4">
          ...
          <p class="fs-12 text-muted mt-0 mb-1"><i
              class="far fa-clock mr-1"></i><?php echo get_time_ago($notification->noti_time) ?></p>
        </div>
      </div>
    </a>
  ...
  <a href="<?php echo base_url('admin/notifications/all') ?>"
    class="py-3 dropdown-item dropdown-footer"><?php echo trans('see-all') ?></a>
</div>