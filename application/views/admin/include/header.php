...
<head>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav pl-3">
      ...
      <?php else: ?>
        <li class="nav-item d-sm-inline-blocks d-none">
          <span class="btn btn-secondary-soft border-1 btn-sm mt-1 ml-2"><i class="bi bi-clock"></i> <?php echo get_my_time_by_zone(get_by_id(user()->time_zone , 'time_zone')->name); ?></span>
        </li>
      <?php endif; ?>
    </ul>
