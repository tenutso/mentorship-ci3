        ...
        <?php if (is_admin()): ?>
          ...
          <li class="nav-item has-treeview <?php if(isset($page) && $page == "Payouts"){echo "menu-open";} ?> ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a class="nav-link <?php if(isset($page_title) && $page_title == "Payout Requests"){echo "active";} ?>" href="<?php echo base_url('admin/payouts/requests') ?>"><i class="lni lni-reload nav-icon"></i> <p><?php echo trans('payout-requests') ?></p></a>
              </li>
