        ...
        <div class="row box-payout-areas">
          ...
          <div class="col-md-4 col-sm-6 col-12 mb-1">
            <div class="info-box-pay border border-success">
              <div class="info-box-content-pay">
                ...
                <span class="info-box-text fw-500 text-muted"> <?php echo trans('balance') ?> </span>
              </div>
          ...
          <div class="col-md-4 col-sm-6 col-12 mb-1">
            <div class="info-box-pay border border-primary">
              <div class="info-box-content-pay">
                ...
                <span class="info-box-text fw-500 text-muted"><?php echo trans('total-earnings') ?> <span class="small">(<?php echo trans('after-commission-of') ?> <?php echo settings()->commission_rate ?>%)</span></span>
          ...
          <div class="col-md-4 col-sm-6 col-12 mb-1">
            <div class="info-box-pay border border-warning">
              <div class="info-box-content-pay">
                <span class="info-box-number-pay text-warning"><?php echo settings()->currency_symbol ?> <?php echo html_escape($total_withdraw);  ?></span>
                <span class="info-box-text fw-500 text-muted"> <?php echo trans('total-withdraw') ?></span>
                <span class="small mt-1"></span>
              </div>
              <!-- /.info-box-content-pay -->
            </div>
