                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 d-hide">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="discount_type">
                                        ...
                                        <option value="redemable"><?php echo trans('redemable') ?><?php echo trans('redemable') ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <p class="small"><?php echo trans('how-many-time-the-code-can-be-used') ?></p>
                            </div>
                              ...
                              <?php $i=1; foreach ($coupons as $row): ?>
                                <tr id="row_<?php echo html_escape($row->uid); ?>">
                                    ...
                                    <td>
                                      ...
                                      <p class="mb-0"><?php echo ucfirst($row->discount_type); ?> (<?php echo html_escape($row->discount); ?>%)</p>
                                      ...
                                      <?php if ($row->discount_type == 'redemable'): ?>
                                        ...
                                        <p class="mb-0"><?php echo html_escape($row->days); ?> <?php echo trans('days') ?></p>
                                      <?php else: ?>
                                      <?php endif ?>
                                    </td>
                                    <td>
