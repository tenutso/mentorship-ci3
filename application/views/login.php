            ...
            <div class="col-md-5 p-5 mx-auto my-5" data-aos="fade-up" data-aos-duration="400">
                <div class="shadow rounded bg-white py-6 px-6 border-0" id="login-area">
                    ...
                    <div class="mb-6 text-center">
                        <?php get_last_logins(); ?>
                        <h4 class="font-weight-bold mb-2"><a href="<?php echo base_url() ?>"><img class="w-60"
                                    src="<?php echo base_url(settings()->logo) ?>"></a></h4>
                    ...
                    <form id="login-form" method="post" action="<?php echo base_url('auth/log'); ?>">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user_name"
                                        placeholder="<?php echo trans('enter-email-or-username') ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password"
                                        placeholder="<?php echo trans('enter-password') ?>" autocomplete="off">
                                </div>

                                <div class="text-left text-sm-left">
                                    <a href="#"
                                        class="m-link-muted small forgot_pass text-dark"><?php echo trans('forgot-password') ?></a>
                                </div>
                            </div>
                        </div>
                        <?php if (settings()->enable_wildapricot_sso): ?>
                            <div class="row">
                                <div class="col-md-12 center">
                                    <button type="button"
                                        class="wa-oauth-login btn btn-secondary btn-block mt-4 mb-0"><?php echo settings()->wildapricot_button_text; ?></button>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 center">
                                ...
                                <button type="submit"
                                    class="btn btn-primary btn-block mt-4 mb-0 signin_btn"><?php echo trans('sign-in') ?>
                                </button>
                            </div>
                        </div>

                        <div class="text-center text-small mt-4">
                            <span><?php echo trans('an-account-yet') ?> <a
                                    href="<?php echo base_url('register') ?>"><?php echo trans('register') ?></a></span>
                        </div>
                ...
                <div id="forgot-area" class="shadow-sm rounded bg-white py-6 px-8 border-0 d-hide">
                    ...
                    <div class="mb-6 text-center">
                        <h2 class="font-weight-bold mb-0"><a href="<?php echo base_url() ?>"><img width="30%"
                                    src="<?php echo base_url(settings()->logo) ?>"></a></h2>
                    ...
                    <form id="lost-form" method="post" action="<?php echo base_url('auth/forgot_password'); ?>">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    <select class="form-control" name="role" id="exampleFormControlSelect1">
                                        ...
                                        <option value="mentor"><?php echo trans('mentor') . '/' . trans('mentee') ?>
                                        </option>
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="email" required
                                        placeholder="<?php echo trans('enter-your-email') ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 text-left text-sm-left">
                                <a href="#" class="small back_login"><i class="fas fa-long-arrow-left"></i>
                                    <?php echo trans('back') ?></a>
                            </div>
                            <div class="col-md-12 center">
                                <!-- csrf token -->
                                <input type="hidden"
                                    ...
                                    value="<?php echo html_escape($this->security->get_csrf_hash()); ?>">
                                <button type="submit"
                                    class="btn btn-primary btn-block mt-4 mb-0"><?php echo trans('submit') ?></button>
                            </div>
                        </div>
