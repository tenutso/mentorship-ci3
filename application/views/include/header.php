...
<head>
    ...
    <meta name="author" content="<?php if(!empty($company)){echo html_escape($company->name);} ?>">
    <meta name="description" content="<?php if(!empty($company)){echo html_escape($company->description);} ?>">
    <meta name="keywords" content="<?php if(!empty($company)){echo html_escape($company->keywords);} ?>">
    <?php else: ?>
    ...
    <!-- overwrite css -->
    <?php $font = get_by_id(settings()->site_font,'fonts'); ?>
    <link href="https://fonts.googleapis.com/css?family=<?php echo str_replace(' ', '+', isset($font)?$font->name:'lato'); ?>:400,500,600,700" rel="stylesheet">
                                ...
                                <li class="nav-item mr-0">
                                    ...
                                    <?php elseif(is_mentee()): ?>
                                        ...
                                        <a class="btn btn-sm btn-light-secondary ml-auto" href="<?php echo base_url('auth/logout') ?>"><i class="lni lni-exit"></i> <?php echo trans('logout') ?> </a>
                                         ...
                                         <a class="btn btn-sm btn-primary ml-auto" href="<?php echo base_url('admin/dashboard/mentee') ?>"><i class="bi bi-speedometer2"></i> <?php echo trans('dashboard') ?></a>
                                    <?php elseif(is_user()): ?>
