...
$route['admin/mentors'] = 'admin/users';
$route['admin/mentees'] = 'admin/mentee/all';
...
//oauth routes
//$route['oauth2'] = 'oauth2/';
$route['wa/auth/oauth'] = 'wildapricot/oauth';
$route['wa/auth/register'] = 'wildapricot/register';
$route['wa/auth/complete_registration'] = 'wildapricot/complete_registration';
...
$route['favourite'] = 'home/add_favourite';
$route['mentor/(:any)'] = 'home/mentor/$1';
$route['session/(:any)'] = 'home/session/$1';
$route['booking/(:any)/(:any)'] = 'home/booking/$1/$2';
$route['sessions/(:any)'] = 'home/sessions/$1';
$route['page/(:any)/(:any)'] = 'company/page_details/$1/$2';
