...
if ($phpversion <= 7.1 || $phpversion >= 8.3) {
    die('<div style="background: rgba(220,53,69,.1); padding: 50px; margin:300px 0px; color: red; font-size: 20px; font-family: Arial">You are using phpversion:<b>'.phpversion().'</b>, Please set your phpversion <b>7.4 / 8.0 / 8.1 </b>from cPanel to continue the installation</div>');
}
...
if (isset($_POST["btn_purchase_code"])) {
    ...
    $_SESSION["purchase_code"] = 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx';
	$_SESSION["status"] = 200;
	$_SESSION["license_code"] = 'hmetdd6wvqn8zt2nwyhdolrskbvky54rrtvhw6u8';
...
<head>
    ...
    <title>Mentorship &bull; Installer</title>

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="assets/css/libs/font-awesome.min.css">
    <link href="https://fonts.googleapis.com/css?family=Alata:400,500,600,700&display=swap" rel="stylesheet">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter random values" required></textarea>
                                            </div>
